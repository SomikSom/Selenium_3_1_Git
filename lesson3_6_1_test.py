...
class TestStepikParametrize:
    ...
    def test_stepik_parametrize(self, browser, link):
        ...
        # button_resset = browser.find_element(By.XPATH, '//*[@id="ember79"]/div/section/div/div[1]/div[3]/button[2]')
        # button_resset.click()
        #
        # button_ok = browser.find_element(By.XPATH, '//*[@id="ember109"]/button[1]')
        # button_ok.click()

        input_text = browser.find_element(By.XPATH, '//textarea')
        result = math.log(int(time.time() - 307.842))
